...
from screenpilot.utils.timing import FPSCounter, Timer


def resolve_region(args: argparse.Namespace) -> CaptureRegion:
    if args.window:
        from screenpilot.capture.window_finder import find_window
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ScreenPilot M1 Benchmark")
