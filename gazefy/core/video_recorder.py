"""Video recorder: captures screen as video + click events simultaneously.
...
Session directory structure:
    recordings/session_YYYYMMDD_HHMMSS/
        ...
        events.jsonl      - Click events: {t, x, y, click}
...
class VideoRecorder:
    """Records screen to video + click events to JSONL simultaneously.
